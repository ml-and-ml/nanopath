...
| `configs/expr-uncertainty.yaml` | Expression regression with one learned log variance per tile | Main + global variance control | Pending |
| `configs/expr-global-var.yaml` | Expression regression with one learned log variance shared by all tiles | Main | Pending |
